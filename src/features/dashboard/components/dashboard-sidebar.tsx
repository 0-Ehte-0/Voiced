...
export function DashboardSidebar() {
    ...
    const otherMenuItems: MenuItem[] = [
        ...
        { title: 'Help & Feedback', url: "mailto:nebulousmd@gmail.com", icon: Headphones },
    ]
        ...
        <Sidebar collapsible='icon'>
            <SidebarHeader className='flex flex-col gap-4 pt-4'>
                <div className='flex items-center gap-2 pl-1 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:pl-0'>
                    <Image src="/logo.svg" alt="Voiced" width={24} height={24} className='rounded-sm'/>
                    <span className='group-data-[collapsible=icon]:hidden font-semibold text-lg tracking-tighter text-foreground'>Voiced</span>
            ...
            <SidebarContent>
                <NavSection items={mainMenuItems} pathname={pathname}></NavSection>
                <NavSection label='Other' items={otherMenuItems} pathname={pathname}></NavSection>
            </SidebarContent>
            <div className='border-b border-dashed border-border'/>
